...
var ConvertCmd = &cobra.Command{
	Use:   "convert",
	Short: "Convert Vulnerability dictionary",
	Long:  `Convert Vulnerability dictionary`,
}

func init() {
	// subcommands
	ConvertCmd.AddCommand(convertRedHatCmd)
	ConvertCmd.AddCommand(convertOracleCmd)
	ConvertCmd.AddCommand(convertAmazonCmd)
